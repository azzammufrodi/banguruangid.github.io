...
<body class="bg-slate-200">
    ...
    <!-- Main Content -->
        ...
        <div class="items-center p-5">
            <div class="card-body">
                <h4 class="font-bold text-4xl text-center text-gray-800 drop-shadow-sm">RUMUS BALOK</h4>
            </div>
            <!-- INPUT -->
            ...
            <p class="py-2 text-base text-gray-600 drop-shadow-sm">Masukan Nilai</p>
              <input  class="shadow-sm m-3 p-2 border-2 border-stone-500 focus: outline-none focus:border-sky-500 focus:ring-sky-200 focus:ring-1 rounded-md text-center placeholder:text-gray-300"
               type="text" name="nilai_a" placeholder="Nilai Panjang" required>
  
              <input  class="shadow-sm p-2 m-2 border-2 border-stone-500 focus: outline-none focus:border-sky-500 focus:ring-sky-200 focus:ring-1 rounded-md text-center placeholder:text-gray-300"
               type="text" name="nilai_b" placeholder="Nilai Lebar" required>

              <input  class="shadow-sm p-2 m-2 border-2 border-stone-500 focus: outline-none focus:border-sky-500 focus:ring-sky-200 focus:ring-1 rounded-md text-center placeholder:text-gray-300"
               type="text" name="nilai_c" placeholder="Nilai Tinggi" required>
    ...
    $jumlahluas =  2 * (($nilai_a * $nilai_b)+($nilai_a*$nilai_c)+($nilai_b*$nilai_c));
    $jumlahkeliling = 4 * ($nilai_a + $nilai_b + $nilai_c);
    $jumlahvolume = $nilai_a * $nilai_b * $nilai_c;
// PRINT
    // echo "LUAS BALOK ADALAH :<b> $jumlahluas CM² </b>";
    // echo "<br><br>KELILING BALOK ADALAH :<b> $jumlahkeliling CM² </b>";
    // echo "<br><br>VOLUME BALOK ADALAH : <b> $jumlahvolume CM³ </b>";
// PRINT END
?>
