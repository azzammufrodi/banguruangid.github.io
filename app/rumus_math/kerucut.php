...
<body class="bg-slate-200">
  ...
  <!-- Main Content -->
    <div class="items-center p-5">
      <div class="card-body">
        <h4 class="font-bold text-4xl text-center text-gray-800 drop-shadow-sm">RUMUS KERUCUT</h4>
      </div>
    <!-- INPUT -->
      ...
      <p class="py-2 text-base text-gray-600 drop-shadow-sm">Masukan Nilai</p>
        <input class="shadow-sm m-2 p-2 border-2 border-stone-500 focus: outline-none focus:border-sky-500 focus:ring-sky-200 focus:ring-1 rounded-md text-center placeholder:text-gray-300"
         type="text" name="nilai_a" placeholder="Nilai Jari - Jari" required>
        <input class="shadow-sm m-2 p-2 border-2 border-stone-500 focus: outline-none focus:border-sky-500 focus:ring-sky-200 focus:ring-1 rounded-md text-center placeholder:text-gray-300"
  ...
  <?php 
    ...
    $garispelukis =  sqrt(pow($nilai_a,2) + pow($nilai_b,2));
    $jumlahluaspermukaan =  (3.14 * pow($nilai_a,2)) + (3.14 * $nilai_a * $garispelukis);
    $jumlahvolume = ( 1 * 3.14 * pow($nilai_a,2) * $nilai_b) / 3;
    $jumlahluas = 3.14 * ($nilai_a * $garispelukis);
// PRINT
    // echo "LUAS PERMUKAAN KERUCUT ADALAH : <b>$jumlahluaspermukaan CM²</b>";
    // echo "<br><br>LUAS SELIMUT KERUCUT ADALAH : <b>$jumlahluas CM²</b>";
    // echo "<br><br>VOLUME KERUCUT ADALAH : <b>$jumlahvolume CM³</b> ";
// END PRINT
?>
...
<!-- END Detail Button -->
            <h2 class="font-bold lg:text-3xl">LUAS PERMUKAAN KERUCUT</h2>
            <H1 class=" text-xl lg:text-5xl md:text-2xl"><?= number_format($jumlahluaspermukaan)?>cm²</H1>
        </div>
        <div class=" w-auto lg:w-auto p-4 border-2 border-stone-500 rounded-lg text-center shadow-md m-3 ">
            <h2 class="font-bold lg:text-3xl">LUAS SELIMUT KERUCUT</h2>
            <H1 class=" text-xl lg:text-5xl md:text-2xl"><?=number_format($jumlahluas) ?>cm²</H1>
        </div>
        <div class=" w-auto lg:w-auto p-4 border-2 border-stone-500 rounded-lg text-center shadow-md m-3">
            <h2 class="font-bold lg:text-3xl">VOLUME KERUCUT</h2>
