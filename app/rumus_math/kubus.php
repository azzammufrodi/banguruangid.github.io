...
<body class="bg-slate-200">
    ...
    <div class="items-center p-5">
        <div class="card-body">
            <h4 class="font-bold text-4xl text-center text-gray-800 drop-shadow-sm">RUMUS KUBUS</h4>
        </div>
        <!-- SISI KUBUS -->
        <form action="" method="POST" class=" text-center">
            <p class="py-2 text-base text-gray-600 drop-shadow-sm">Masukan Nilai</p>
            <input
                class="shadow-sm p-2 border-2 border-stone-500 focus: outline-none focus:border-sky-500 focus:ring-sky-200 focus:ring-1 rounded-md text-center placeholder:text-gray-300"
                type="text" name="nilai_a" placeholder="Nilai Sisi" required>
            <br><br>
            <input
                class="cursor-pointer drop-shadow-md w-52 h-auto p-2 rounded-md text-slate-100 bg-orange-400 hover:bg-orange-500 hover:border-orange-400 hover:ring-orange-300 hover:ring-1 hover:outline-none"
    ...
    $jumlahluas =  6 * $nilai_a;
    $jumlahkeliling = 12 * $nilai_a ;
    $jumlahvolume = $nilai_a * $nilai_a * $nilai_a ;
// // PRINT
//     echo "LUAS KUBUS ADALAH : <b>$jumlahluas CM²</b>";
//     echo "<br><br>KELILING KUBUS ADALAH : <b>$jumlahkeliling CM²</b>";
//     echo "<br><br>VOLUME KUBUS ADALAH : <b>$jumlahvolume CM³</b> ";
// // END PRINT
?>
